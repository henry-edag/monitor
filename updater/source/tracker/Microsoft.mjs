...
const Microsoft = function(database, updater) {
...
Microsoft.prototype = Object.assign({}, Emitter.prototype, {
	...
	'export': function() {
		...
		Object.keys(this.__state['advisories']).forEach((identifier) => {
			...
			// TODO: mergeAdvisory.call(this, vulnerability, data);
			// TODO: Call this.database.update(vulnerability);
