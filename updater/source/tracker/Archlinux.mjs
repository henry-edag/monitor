...
const download_avg = function(avg_id, callback) {
	...
	this.webscraper.request('https://security.archlinux.org/' + avg_id + '.json', (avg_details) => {
...
const download_cve = function(cve_id, callback) {
	...
	this.webscraper.request('https://security.archlinux.org/' + cve_id + '.json', (cve_details) => {
...
const mergeVulnerability = function(vulnerability, data) {
...
const Archlinux = function(database, updater) {
...
Archlinux.prototype = Object.assign({}, Emitter.prototype, {
	...
	'export': function() {
		...
		console.info('Archlinux: Export');


		Object.values(this.__state['cve']).forEach((entry) => {

			let vulnerability = this.database.read(entry['name']);
			if (vulnerability['is_edited'] === false) {

				mergeVulnerability.call(this, vulnerability, entry);
		...
		setTimeout(() => {
			...
			console.info('Archlinux: Export complete.');
